...
# 复合索引：用于高效查询特定项目的切片并按状态或评分排序
Index('idx_clip_project_status', Clip.project_id, Clip.status)
Index('idx_clip_project_score', Clip.project_id, Clip.score)