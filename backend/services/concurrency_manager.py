...
# 全局异步并发管理器实例
async_concurrency_manager = AsyncConcurrencyManager(max_concurrent=10)
...
def with_async_concurrency_limit(max_concurrent: int = 10):
    """
    异步并发限制装饰器
    ...
    Usage:
        ...
        async def process_video_async(project_id: str, task_id: str):
            # 函数体
            pass
    """
    manager = AsyncConcurrencyManager(max_concurrent)
