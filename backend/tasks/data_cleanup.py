...
def _cleanup_orphaned_files() -> int:
    ...
    try:
        from core.path_utils import get_projects_directory, get_output_directory, get_temp_directory
...
def _cleanup_temp_files() -> int:
    ...
    try:
        from core.path_utils import get_projects_directory, get_temp_directory
